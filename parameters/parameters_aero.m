...
Init.xyz = [0 0 -50];                   % Initial position (inertial) [m]
...
Init.attitude(3) = wrapTo180(0);        % Initial yaw angle [deg]
...
%%%%%%%%%%%%%%  WIND  %%%%%%%%%%%
Init.windAmp = 4;                       % Wind amplitude (inertial NED) [m/s]
...
Init.WTimevar = 0;                      % Turn on or off slowly time-varying wind [0,1]
